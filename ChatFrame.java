...
public class ChatFrame extends JFrame {
	...
	public ChatFrame(String username, DataInputStream dis, DataOutputStream dos) {
		...
		btnSend.setIcon(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/component/send.png"));
		...
		btnFile.setIcon(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/component/attack.png"));
		...
		JLabel smileIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/smile.png"));
		smileIcon.addMouseListener(new IconListener(smileIcon.getIcon().toString()));
		emojis.add(smileIcon);
		
		JLabel bigSmileIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/big-smile.png"));
		bigSmileIcon.addMouseListener(new IconListener(bigSmileIcon.getIcon().toString()));
		emojis.add(bigSmileIcon);
		
		JLabel happyIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/happy.png"));
		happyIcon.addMouseListener(new IconListener(happyIcon.getIcon().toString()));
		emojis.add(happyIcon);
		
		JLabel loveIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/love.png"));
		loveIcon.addMouseListener(new IconListener(loveIcon.getIcon().toString()));
		emojis.add(loveIcon);
		
		JLabel sadIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/sad.png"));
		sadIcon.addMouseListener(new IconListener(sadIcon.getIcon().toString()));
		emojis.add(sadIcon);
		
		JLabel madIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/mad.png"));
		madIcon.addMouseListener(new IconListener(madIcon.getIcon().toString()));
		emojis.add(madIcon);
		
		JLabel suspiciousIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/suspicious.png"));
		suspiciousIcon.addMouseListener(new IconListener(suspiciousIcon.getIcon().toString()));
		emojis.add(suspiciousIcon);
		
		JLabel angryIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/angry.png"));
		angryIcon.addMouseListener(new IconListener(angryIcon.getIcon().toString()));
		emojis.add(angryIcon);
		
		JLabel confusedIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/confused.png"));
		confusedIcon.addMouseListener(new IconListener(confusedIcon.getIcon().toString()));
		emojis.add(confusedIcon);
		
		JLabel unhappyIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/unhappy.png"));
		unhappyIcon.addMouseListener(new IconListener(unhappyIcon.getIcon().toString()));
		emojis.add(unhappyIcon);
		
		JLabel appleIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/apple.png"));
		appleIcon.addMouseListener(new IconListener(appleIcon.getIcon().toString()));
		emojis.add(appleIcon);
		
		JLabel orangeIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/orange.png"));
		orangeIcon.addMouseListener(new IconListener(orangeIcon.getIcon().toString()));
		emojis.add(orangeIcon);
		
		JLabel cherryIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/cherry.png"));
		cherryIcon.addMouseListener(new IconListener(cherryIcon.getIcon().toString()));
		emojis.add(cherryIcon);
		
		JLabel cakeIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/cake.png"));
		cakeIcon.addMouseListener(new IconListener(cakeIcon.getIcon().toString()));
		emojis.add(cakeIcon);
		
		JLabel vietnamIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/vietnam.png"));
		vietnamIcon.addMouseListener(new IconListener(vietnamIcon.getIcon().toString()));
		emojis.add(vietnamIcon);
		
		JLabel usIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/us.png"));
		usIcon.addMouseListener(new IconListener(usIcon.getIcon().toString()));
		emojis.add(usIcon);
		
		JLabel ukIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/uk.png"));
		ukIcon.addMouseListener(new IconListener(ukIcon.getIcon().toString()));
		emojis.add(ukIcon);
		
		JLabel canadaIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/canadaIcon.png"));
		canadaIcon.addMouseListener(new IconListener(canadaIcon.getIcon().toString()));
		emojis.add(canadaIcon);
		
		JLabel italyIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/italy.png"));
		italyIcon.addMouseListener(new IconListener(italyIcon.getIcon().toString()));
		emojis.add(italyIcon);
		
		JLabel spainIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/spainIcon.png"));
		spainIcon.addMouseListener(new IconListener(spainIcon.getIcon().toString()));
		emojis.add(spainIcon);
		
		JLabel egyptIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/egyptIcon.png"));
		egyptIcon.addMouseListener(new IconListener(egyptIcon.getIcon().toString()));
		emojis.add(egyptIcon);
		
		JLabel swedenIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/sweden.png"));
		swedenIcon.addMouseListener(new IconListener(swedenIcon.getIcon().toString()));
		emojis.add(swedenIcon);
		
		JLabel australiaIcon = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/australia.png"));
		australiaIcon.addMouseListener(new IconListener(australiaIcon.getIcon().toString()));
		emojis.add(australiaIcon);
		
		JLabel userImage = new JLabel(new ImageIcon("/home/thaihocit02/thaihoc/code/project test/src/project/data/icon/emoji/user.png"));
		...
		JLabel headerContent = new JLabel("FINAL GROUP 4 PROJECT");
	...
	class Receiver implements Runnable{
		...
		public void run() {
			try {		
				...
				while (true) {
					...
					if (method.equals("Text")) {
						...
						String emoji = dis.readUTF();
                                                ...
                                                logMessage(sender, "sent an emoji: " + emoji);
						...
						while (size > 0) {
							...
							size -= bufferSize;
                                                ...
                                                logMessage(sender, "sent a file: " + filename);
                ...
                // Hàm ghi tin nhắn vào log
                private void logMessage(String sender, String message) {
                    String logFile = getChatLogFile(); // Lấy tên tệp log riêng
                ...
                // Hàm hiển thị lịch sử tin nhắn từ tệp log
                private void displayChatHistory() {
                    String logFile = getChatLogFile(); // Lấy tên tệp log riêng

                    // In ra tên tệp log để kiểm tra
                    System.out.println("Đang mở tệp log: " + logFile);

                    try (BufferedReader reader = new BufferedReader(new FileReader(logFile))) {
                        String line;
                        while ((line = reader.readLine()) != null) {
                            System.out.println("Đọc tin nhắn từ log: " + line); // In ra nội dung tin nhắn
                            appendMessageToChatWindow(line); // Hiển thị tin nhắn
                        }
                    } catch (IOException e) {
                        System.err.println("Không thể đọc tệp log hoặc tệp không tồn tại: " + logFile);
                    }
                }

                private String getChatLogFile() {
                    // Lấy tên người đang chat
                    String chatting = lbReceiver.getText();
                    // Sắp xếp tên để đảm bảo cùng một tệp cho cả hai người
                    String[] users = {username, chatting};
                    java.util.Arrays.sort(users); // Sắp xếp tên theo thứ tự alphabet
                    return users[0] + "_" + users[1] + "_chatlog.txt";
                }

                // Hàm để hiển thị tin nhắn vào JTextPane (chat window)
                private void appendMessageToChatWindow(String message) {
                    try {
                        // Kiểm tra xem message có đúng không
                        System.out.println("Đang hiển thị tin nhắn: " + message);

                        chatWindow.getDocument().insertString(chatWindow.getDocument().getLength(), message + "\n", null);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
